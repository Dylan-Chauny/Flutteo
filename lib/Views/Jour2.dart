...
class Jour2 extends StatelessWidget{
  @override
                ...
                children: <Widget>[
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(fcst1.dayLong.toString()),
                      Text(fcst1.date.toString() + " | " + cond.hour.toString()),
                      Text("Temp min: " + fcst1.tmin.toString()+"°"),
                      Text("Temp max: " + fcst1.tmax.toString()+"°"),
